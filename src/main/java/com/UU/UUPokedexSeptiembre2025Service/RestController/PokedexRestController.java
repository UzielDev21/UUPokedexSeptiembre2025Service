...
public class PokedexRestController {
     ...
     *
     * Parámetros soportados: - sear: Búsqueda por nombre o ID (ej: "pikachu") -
     * type: Filtro por tipo (ej: "fire", "water") - limit: Cantidad de
     * resultados (default: 12, máximo: 48) - offset: Desplazamiento para
     * paginación (default: 0) - sort: Ordenamiento (id_asc, id_desc, name_asc,
     * name_desc)
     *
     * Ejemplos: - GET /api/pokedex?sear=pikachu - GET
     * /api/pokedex?type=fire&limit=20&sort=name_asc - GET
     * /api/pokedex?limit=30&offset=0
     *
     * Las excepciones lanzadas son interceptadas por GlobalExceptionHandler que
     * mapea estados HTTP apropiados (400, 404, 500, etc).
     *
